...
namespace OrganizationTrackingApplicationData.Migrations
{
    ...
    [Migration("20240601152033_EventDescriptionAdded")]
            ...
            modelBuilder.Entity("Entities.Domain.EventType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b885a452-42ad-425b-9aa4-9840d19eb85e"),
                            CreatedDate = new DateTime(2024, 6, 1, 18, 20, 32, 260, DateTimeKind.Local).AddTicks(6953),
                            IsDeleted = false,
                            Name = "Concert",
                            UpdatedDate = new DateTime(2024, 6, 1, 18, 20, 32, 260, DateTimeKind.Local).AddTicks(6963)
                        },
                        new
                        {
                            Id = new Guid("7bc672e2-c0ea-45b7-953a-6b531ff840e0"),
                            CreatedDate = new DateTime(2024, 6, 1, 18, 20, 32, 260, DateTimeKind.Local).AddTicks(6993),
                            IsDeleted = false,
                            Name = "Carnival",
                            UpdatedDate = new DateTime(2024, 6, 1, 18, 20, 32, 260, DateTimeKind.Local).AddTicks(6993)
                        },
                        new
                        {
                            Id = new Guid("83205c21-c8b1-4bae-8214-50ae8a6440a2"),
                            CreatedDate = new DateTime(2024, 6, 1, 18, 20, 32, 260, DateTimeKind.Local).AddTicks(7014),
                            IsDeleted = false,
                            Name = "Festival",
                            UpdatedDate = new DateTime(2024, 6, 1, 18, 20, 32, 260, DateTimeKind.Local).AddTicks(7014)
                        },
                        new
                        {
                            Id = new Guid("219b4456-6e66-4bd9-b55f-dd4c4a5199cd"),
                            CreatedDate = new DateTime(2024, 6, 1, 18, 20, 32, 260, DateTimeKind.Local).AddTicks(7018),
                            IsDeleted = false,
                            Name = "Meeting",
                            UpdatedDate = new DateTime(2024, 6, 1, 18, 20, 32, 260, DateTimeKind.Local).AddTicks(7018)
                        },
                        new
                        {
                            Id = new Guid("1bf414fd-9224-4dec-96da-e90e269225a9"),
                            CreatedDate = new DateTime(2024, 6, 1, 18, 20, 32, 260, DateTimeKind.Local).AddTicks(7022),
                            IsDeleted = false,
                            Name = "Activity",
                            UpdatedDate = new DateTime(2024, 6, 1, 18, 20, 32, 260, DateTimeKind.Local).AddTicks(7022)
                        },
                        new
                        {
                            Id = new Guid("7923ad09-a6ae-44df-bb85-a0e6140bc02f"),
                            CreatedDate = new DateTime(2024, 6, 1, 18, 20, 32, 260, DateTimeKind.Local).AddTicks(7028),
                            IsDeleted = false,
                            Name = "Trip",
                            UpdatedDate = new DateTime(2024, 6, 1, 18, 20, 32, 260, DateTimeKind.Local).AddTicks(7029)
                        });
                });
