    ...
    public class OrganizationTrackingApplicationQuery : IOrganizationTrackingApplicationQuery
    {
        ...
        private static System.Linq.Expressions.Expression<Func<Event, bool>> EventFilterBuilder(EventSearchModel eventFilter)
        {
            ...
            if (!eventFilter.OrganizatorName.IsNullOrEmpty())
                predicateBuilder.And(a => a.Organizator.Name.ToLower().Contains(eventFilter.OrganizatorName.ToLower()));
            ...
            {
                predicateBuilder.And(a => a.Location.Longitude + eventFilter.Radius * (0.009009) > eventFilter.Longitude && a.Location.Longitude - eventFilter.Radius * (0.009009) < eventFilter.Longitude);

                predicateBuilder.And(a => a.Location.Latitude + eventFilter.Radius * (0.009009) > eventFilter.Latitude && a.Location.Latitude - eventFilter.Radius * (0.009009) < eventFilter.Latitude);
            }
